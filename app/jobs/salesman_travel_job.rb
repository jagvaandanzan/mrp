class SalesmanTravelJob < ApplicationJob
  ...
  def parse_data(obj_type, obj)
    if obj_type == "sale"
      ...
      {obj_type: obj_type, latitude: location.latitude.to_s, longitude: location.longitude.to_s, sale_id: obj.id, phone: obj.phone, name: location.full_name,
       delivery_hour: obj.delivery_hour, allocation_type: obj.allocation_type, is_country: obj.is_country}
    else
