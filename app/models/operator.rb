class Operator < ApplicationRecord
  ...
  attr_accessor :comment_minute, :comment_count, :comment_avg, :no_replied, :reply_percent, :to_chat_count,
                :user_count, :like_count, :remove_count, :hide_count, :user_hide_count, :user_remove_count, :mpr_phone, :mrp_price
